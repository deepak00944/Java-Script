...
console.log(gameName.anchor("hiihello"))  //<a name="hiihello">deepak-ds-jsk</a>
...
console.log(gameName) //[String: 'deepak-ds-jsk']
console.log(gameName[0]); // d
console.log(gameName.__proto__);
console.log(gameName.length);//13
console.log(gameName.toUpperCase());//DEEPAK-DS-JSK
console.log(gameName.split("-")) //[ 'deepak', 'ds', 'jsk' ] this will give the array
